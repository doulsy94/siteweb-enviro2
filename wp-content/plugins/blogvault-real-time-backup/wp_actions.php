	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '2f3a2ac393cca5b8121090d3acc29a26', 'ac98c39aee3ba26606aa43eafe6a5a58');
		BVAccount::updateApiPublicKey($this->settings, '2f3a2ac393cca5b8121090d3acc29a26');
			}
